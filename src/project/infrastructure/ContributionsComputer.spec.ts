...
describe('ContributionsModelService', () => {
  ...
  beforeEach(() => {
    ...
    project3a = modelFaker.project(UserId.create());
    project3b = modelFaker.project(UserId.create());
    project3c = modelFaker.project(UserId.create());
    project3d = modelFaker.project(UserId.create());
    project4 = modelFaker.project(UserId.create());
    project4a = modelFaker.project(UserId.create());
    project4b = modelFaker.project(UserId.create());
    project4c = modelFaker.project(UserId.create());
    project5a = modelFaker.project(UserId.create());
    project5b = modelFaker.project(UserId.create());
    project7 = modelFaker.project(UserId.create());
    project8 = modelFaker.project(UserId.create());
    project3.reviewTopics.add(modelFaker.reviewTopic());
    project3a.reviewTopics.add(modelFaker.reviewTopic());
    project3b.reviewTopics.add(modelFaker.reviewTopic());
    project3c.reviewTopics.add(modelFaker.reviewTopic());
    project3d.reviewTopics.add(modelFaker.reviewTopic());
    project4.reviewTopics.add(modelFaker.reviewTopic());
    project4a.reviewTopics.add(modelFaker.reviewTopic());
    project4b.reviewTopics.add(modelFaker.reviewTopic());
    project4c.reviewTopics.add(modelFaker.reviewTopic());
    project5a.reviewTopics.add(modelFaker.reviewTopic());
    project5b.reviewTopics.add(modelFaker.reviewTopic());
    project7.reviewTopics.add(modelFaker.reviewTopic());
    project8.reviewTopics.add(modelFaker.reviewTopic());
    role1 = modelFaker.role();
    role2 = modelFaker.role();
    role3 = modelFaker.role();
    role4 = modelFaker.role();
    role5 = modelFaker.role();
    role6 = modelFaker.role();
    role7 = modelFaker.role();
    role8 = modelFaker.role();
    a = role1.id.value;
    b = role2.id.value;
    c = role3.id.value;
    d = role4.id.value;
  ...
  describe('covee method', () => {
    ...
    test('compute contributions from experiment with 8 persons', () => {
    ...
    test('compute contributions from experiment with 7 persons', () => {
    ...
    test('compute contributions from experiment with 5 persons, case A', () => {
    ...
    test('compute contributions from experiment with 5 persons, case B', () => {
    ...
    test('compute contributions from experiment with 4 persons, case A', () => {
    ...
    test('compute contributions from experiment with 4 persons, case B', () => {
    ...
    test('compute contributions from experiment with 4 persons, case C', () => {
    ...
    test('compute contributions from experiment with 3 persons, case A', () => {
    ...
    test('compute contributions from experiment with 3 persons, case B', () => {
    ...
    test('compute contributions from experiment with 3 persons, case C', () => {
    ...
    test('compute contributions from experiment with 3 persons, case D', () => {
