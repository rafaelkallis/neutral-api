...
/**
 * TypeOrm Project Entity
 */
@Entity('projects')
export class TypeOrmProjectEntity extends TypeOrmEntity<Project>
  ...
  public constructor(
    typeOrmProjectRepository: TypeOrmProjectRepository,
    id: string,
    createdAt: number,
    updatedAt: number,
    title: string,
    ...
    super(typeOrmProjectRepository, id, createdAt, updatedAt);
    this.title = title;
