...
import { TokenAudienceIncorrectException } from 'token/application/exceptions/token-audience-incorrect.exception';
import { TokenClaimMissingException } from 'token/application/exceptions/token-claim-missing.exception';
import { TokenExpiredException } from 'token/application/exceptions/token-expired.exception';
import { TokenFromFutureException } from 'token/application/exceptions/token-from-future.exception';
